...
import com.extendedencryption.action.executer.SetEncryptedFlag;
			...
			try {
				...
				RetryingTransactionCallback<Object> callback = new RetryingTransactionCallback<Object>() {
					public Object execute() throws Throwable {
        				...
        				ActionImpl action = new ActionImpl(ref, SetEncryptedFlag.NAME, null);
                        action.setParameterValue(SetEncryptedFlag.PARAM_ACTIVE, activeFlag);
                        SetEncryptedFlag actionExecuter = (SetEncryptedFlag) FacesContextUtils.getWebApplicationContext(fc).getBean(SetEncryptedFlag.NAME);
